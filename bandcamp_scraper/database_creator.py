...
class DatabaseCreator:
    def __init__(self, filepath: str) -> None:
        ...
        self.add_counts()
        self.write_json_from_list(self.database)
    ...
    def _extract_URL(mail: str) -> Union[str, None]:
        if "base64" in mail:
            mail = EmailDecoder.decode_base64(mail)
        if "iso-8859-1" in mail:
            mail = EmailDecoder.decode_iso8859(mail)
    ...
    @staticmethod
    def write_json_from_list(database: list[Dict]) -> None:
